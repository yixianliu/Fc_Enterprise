try {
    Array.prototype.del = function (a) {
        a.sort();
        for (var b = this.concat([]), c = a.length - 1; c >= 0; c--)
            b = b.slice(0, a[c]).concat(b.slice(a[c] + 1));
        return b;
    },
            ...
            function (a) {
                ...
                ShearPhoto[a] = function (b, c, d) {
                    if (!(this instanceof ShearPhoto[a]))
                        return new ShearPhoto[a](b, c, d);
                    ...
                    show: function (b, c) {
                        ...
                        for (h.add(this, "正常", 0, 0, c), this.tempPsLib = h, d = 0; d < this.layers.length; d++)
                            e = this.layers[d],
                    ...
                    save: function (b, c) {
                        ...
                        if (!this.layers.length)
                            return c ? (this.context.putImageData(this.imgData, 0, 0),
                        ...
                        for (d = new ShearPhoto[a](this.canvas.width, this.canvas.height), d.add(this, "正常", 0, 0, b),
                                this.tempPsLib = d, e = 0; e < this.layers.length; e++)
                            f = this.layers[e], g = f[0].layers,
                    ...
                    drawRect: function () {
                        ...
                        for ((a = document.getElementById("imgRect")) || (a = document.createElement("canvas"),
                                ...
                                c = [], d = this.tempPsLib.imgData.data, e = 0, f = d.length; f > e; e++)
                            c[d[e]] ? c[d[e]]++ : c[d[e]] = 1;
                        for (b.beginPath(), b.moveTo(0, a.height), e = d = 0; 255 > e; e++)
                            c[e] > d && (d = c[e]);
                        for (e = 0; 255 > e; e++)
                            f = c[e] || 0, f = a.height - .8 * (f / d) * a.height,
                    ...
                    return {
                        process: function (a, b) {
                            ...
                            for (c = a.data, d = b[0] / 50, e = Math.tan((45 + 44 * ((b[1] || 0) / 50)) * Math.PI / 180),
                                ...
                                for (h = 0; 3 > h; h++)
                                    c[f + h] = (c[f + h] - 127.5 * (1 - d)) * e + 127.5 * (1 + d);
                            return a;
                        }
                    };
                });
                                    ...
                                    []
                                        ...
                                        for (n = j + m, o = - 2; 3 > o; o++)
                                            for (p = 4 * (n * d + (k + o)),
                                                    i = 0; 3 > i; i++)
                                                l[i].push(c[p + i]);
                                    for (j = new a.lib.dorsyMath.Matrix(l, 3, matrixSize).mutiply(e), i = 0; 3 > i; i++)
                                        f[g + i] = j.data[i];
                                    f[g + 4] = c[g + 4];
                                }
                    ...
                    var b = {
                        FFT1: function (a) {
                            function c() {
                                ...
                                for (e++, g = d / Math.pow(2, e), h = d / g, i = 0; g > i; i++)
                                    for (j = i * h,
                                            k = (i + 1) * h - 1, l = e, m = Math.pow(2, l - 1), n = 0; k - m >= j; j++)
                                        o = j + m,
                            ...
                            for (var d = a.length, e = 0, f = [], g = 0; d > g; g++)
                                f[g] = this.exp(-2 * Math.PI * g / d);
                            return c(), a;
                        },
                        DFT: function () {},
                        ...
                        lagrange: function (a, b) {
                            ...
                            return function (d) {
                                var e, f, g, h, i;
                                for (e = 0, f = 0; c > f; f++) {
                                    for (g = 1, h = 1, i = 0; c > i; i++)
                                        i != f && (g *= a[f] - a[i], h *= d - a[i]);
                                    e += b[f] * (h / g);
                                }
                                return e;
                            };
                                    ...
                                    []
                                        ...
                                        for (r = n + q, s = j; - j >= s; s++)
                                            for (t = 4 * (r * g + (o + s)),
                                                    m = 0; 3 > m; m++)
                                                p[m].push(f[t + m]);
                                    for (n = new a.lib.dorsyMath.Matrix(p, 3, h).mutiply(d), m = 0; 3 > m; m++)
                                        i[k + m] = n.data[m];
                                    i[k + 4] = f[k + 4];
                                }
                            for (k = 0, l = f.length; l > k; k++)
                                i[k] && (f[k] = i[k] < e ? i[k] : f[k]);
                            return c;
                        },
                        ...
                        HSIToRGB: function (a, b, c) {
                            if (0 > a ? (a %= 2 * Math.PI, a += 2 * Math.PI) : a %= 2 * Math.PI, a <= 2 * Math.PI / 3)
                                var d = c * (1 - b),
                                        e = c * (1 + b * Math.cos(a) / Math.cos(Math.PI / 3 - a)),
                                        f = 3 * c - (e + d);
                            else
                                a <= 4 * Math.PI / 3 ? (a -= 2 * Math.PI / 3,
                        ...
                        applyInHSI: function (a, b) {
                            var c, d, e, f;
                            for (c = a.data, d = 0, e = c.length; e > d; d += 4)
                                f = this.RGBToHSI(c[d], c[d + 1], c[d + 2]),
                        ...
                        xyCal: function (a, b, c, d, e) {
                            var f, g, h;
                            for (f = this.xyToIFun(a.width), g = 0; 3 > g; g++)
                                h = f(b, c, g), a[h] = d(a[h]);
                            e && (a[h + 1] = e(a[h + 1]));
                        }
                    };
                    return b.Matrix.prototype = {
                        plus: function (a) {
                            ...
                            for (c = new b.Matrix([], this.m, this.n), d = 0; d < this.m; d++)
                                for (e = 0; e < this.n; e++)
                                    c.data[d][e] = this.data[d][e] + a.data[d][e];
                            return c;
                        },
                        minus: function (a) {
                            var c, d, e;
                        ...
                        mutiply: function (a) {
                            ...
                            for (c = new b.Matrix([], this.m, a.n), d = 0; d < this.m; d++)
                                for (e = 0; e < a.n; e++) {
                                    for (f = 0, g = 0; g < this.n; g++)
                                        f += this.data[d][g] * a.data[g][e];
                                    c.data[d][e] = f;
                                }
                            return c;
                        }
                    ...
                    return {
                        process: function (a, b, c) {
                            ...
                            for (b = Math.floor(b) || 3, c = c || b / 3, d = 1 / (Math.sqrt(2 * Math.PI) * c),
                                    g = - 1 / (2 * c * c), h = 0, c = - b; b >= c; c++, h++)
                                f = d * Math.exp(g * c * c),
                                        m[h] = f, n += f;
                            for (h = 0, c = m.length; c > h; h++)
                                m[h] /= n;
                            for (d = 0; l > d; d++)
                                for (c = 0; k > c; c++) {
                                    for (n = e = f = g = 0, i = - b; b >= i; i++)
                                        h = c + i, h >= 0 && k > h && (h = 4 * (d * k + h),
                        ...
                        process: function (a, b) {
                            ...
                            for (c = parseInt(b[0]) || 100, d = a.data, e = a.width, f = a.height, g = 0; e > g; g++)
                                for (h = 0; f > h; h++)
                                    for (i = h * e + g,
                                            j = 0; 3 > j; j++)
                                        k = parseInt(2 * Math.random() * c) - c, d[4 * i + j] += k;
                            return a;
                        }
                    };
                });
                    ...
                    return {
                        process: function (a, b) {
                            ...
                            for (c = parseInt(b[0]) || 16, d = a.data, e = a.width, f = a.height, g = 0; e > g; g++)
                                for (h = 0; f > h; h++) {
                                    for (i = h * e + g, j = 0, k = 0; 3 > k; k++)
                                        j += d[4 * i + k];
                                    for (j /= 3, j = parseInt(j / c) * c, k = 0; 3 > k; k++)
                                        d[4 * i + k] = j;
                                }
                            return a;
                        }
                        ...
                        process: function (a, b) {
                            ...
                            for (c = b[0] || .6, d = a.data, e = a.width, f = 0, g = d.length; g > f; f += 4)
                                if (h = f / 4,
                                    ...
                                    for (k = 4 * ((i - 1) * e + (j - 1)),
                                            i = 4 * ((i - 1) * e + j), h = 4 * (h - 1), j = 0; 3 > j; j++)
                                        d[f + j] += (d[f + j] - (d[i + j] + d[h + j] + d[k + j]) / 3) * c;
                            return a;
                        }
                    };
                });
            ...
            function (a) {
                ShearPhoto[a].module("toGray", function () {
                    return {
                        process: function (a) {
                            var b, c, d, e;
                            for (b = a.data, c = 0, d = b.length; d > c; c += 4)
                                e = parseInt((b[c] + b[c + 1] + b[c + 2]) / 3),
                                        b[c + 2] = b[c + 1] = b[c] = e;
                            return a.data = b, a;
                        }
                    };
            ...
            function (a) {
                ShearPhoto[a].module("toThresh", function (a) {
                    return {
                        process: function (b, c) {
                            var d, e, f;
                            for (b = a.lib.toGray.process(b), d = b.data, c = c[0] || 128, e = 0, f = d.length; f > e; e++)
                                (e + 1) % 4 && (d[e] = d[e] > c ? 255 : 0);
                            return b.data = d, b;
                        }
                    };
                });
