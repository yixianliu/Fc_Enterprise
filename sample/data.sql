...
(NULL, 'EMAIL', '管理员邮箱', '#EMAIL#', NULL, 'On', #TIME#),
...
(NULL, 'FILE_UPLOAD_TYPE', '上传文件格式', '#FILE_UPLOAD_TYPE#', NULL, 'On', #TIME#),
...
/*
    音乐资源
*/
(NULL, 'UP1', '编辑产品',  NULL, 'Home', 'Product', 'Edit', NULL, 'On', 'On', #TIME#),
(NULL, 'UP2', '删除产品',  NULL, 'Home', 'Product', 'Delete', NULL, 'On', 'On', #TIME#),
(NULL, 'UP3', '浏览产品',  NULL, 'Home', 'Product', 'View', NULL, 'On', 'On', #TIME#),
(NULL, 'UP4', '创建产品',  NULL, 'Home', 'Product', 'Create', NULL, 'On', 'On', #TIME#),
(NULL, 'UP5', '产品详情',  NULL, 'Home', 'Product', 'Details', NULL, 'On', 'On', #TIME#),
(NULL, 'UP6', '产品评论',  NULL, 'Home', 'Product', 'Comment', NULL, 'On', 'On', #TIME#),
...
VALUES
(NULL, 'S1', 1, '电影', NULL, NULL, NULL, NULL, 'S0', 'On', 'On', 'On', #TIME#),
(NULL, 'S2', 2, '音乐', NULL, NULL, NULL, NULL, 'S0', 'On', 'On', 'On', #TIME#),
(NULL, 'S3', 3, '图书', NULL, NULL, NULL, NULL, 'S0', 'On', 'On', 'On', #TIME#),
(NULL, 'S4', 4, '文档', NULL, NULL, NULL, NULL, 'S0', 'On', 'On', 'On', #TIME#),
...
/*
    驯力文化 - 前台
*/
(NULL, 'H1', 1, 'M0', 'R15', '驯力文化', '亦以俭自律，不少变。', NULL, 'Home', 'On', #TIME#),
...
(NULL, 'HNS3', 3, 'HN2', 'R15', '所有视频', '所有的版块', NULL, 'movie', 'On', #TIME#),
(NULL, 'HNS4', 4, 'HN2', 'R15', '视频详情', '所有的版块', NULL, 'movie/show', 'On', #TIME#),
...
(NULL, 'HNM1', 1, 'HN4', 'R15', '文档资源分类', '对网站进行全方位管理和操作', NULL, 'doc/classify', 'On', #TIME#),
(NULL, 'HNM2', 2, 'HN4', 'R15', '热门资源', '对网站进行全方位管理和操作', NULL, 'doc/hot', 'On', #TIME#),
(NULL, 'HNM3', 3, 'HN4', 'R15', '所有文档', '对网站进行全方位管理和操作', NULL, 'doc', 'On', #TIME#),

(NULL, 'HNP1', 1, 'HN5', 'R15', '视频资源分类', '最新的产品走向', NULL, 'Classify', 'On', #TIME#),
(NULL, 'HNP2', 2, 'HN5', 'R15', '热门资源', '用户的购买趋势', NULL, 'Hot', 'On', #TIME#),
(NULL, 'HNP3', 3, 'HN5', 'R15', '所有资源', '所有的资源分类', NULL, 'View', 'On', #TIME#),

(NULL, 'HMP1', 1, 'HN3', 'R15', '音乐资源分类', '最新的产品走向', NULL, 'Classify', 'On', #TIME#),
(NULL, 'HMP2', 2, 'HN3', 'R15', '热门资源', '用户的购买趋势', NULL, 'Hot', 'On', #TIME#),
