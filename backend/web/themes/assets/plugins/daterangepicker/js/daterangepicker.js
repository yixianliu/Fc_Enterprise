        ...
        renderCalendar: function (calendar, selected, minDate, maxDate, side) {
            ...
            if (this.timePicker) {
                ...
                if (this.timePicker12Hour) {
                    ...
                    if (selected.hour() >= 12) {
                        html += '<option value="AM"' + am_html + '>上午</option><option value="下午" selected="selected"' + pm_html + '>下午</option>';
                    } else {
                        html += '<option value="AM" selected="selected"' + am_html + '>上午</option><option value="下午"' + pm_html + '>下午</option>';
                    }
                    html += '</select>';
                }
