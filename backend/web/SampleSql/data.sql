...
(NULL, 'AURR1', 1, 'AR1', 'admin', 'UU1', NULL, '所有角色权限', 'item-rp/index', NULL, NULL, 'On', #TIME#, #TIME#),
(NULL, 'AURR2', 2, 'AR1', 'admin', 'UU1', NULL, '添加角色权限', 'item-rp/create', NULL, NULL, 'On', #TIME#, #TIME#),
(NULL, 'AURR3', 3, 'AR1', 'admin', 'UU1', NULL, '所有规则', 'rules/index', NULL, NULL, 'On', #TIME#, #TIME#),
(NULL, 'AURR4', 4, 'AR1', 'admin', 'UU1', NULL, '添加规则', 'rules/create', NULL, NULL, 'On', #TIME#, #TIME#),
