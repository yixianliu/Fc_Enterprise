...
(NULL, 'AP3', 2, 'A3', 'admin', 'UU1', NULL, '采购管理', NULL, 'On', #TIME#, #TIME#),
(NULL, 'AU1', 3, 'A3', 'admin', 'UU1', NULL, '用户管理', NULL, 'On', #TIME#, #TIME#),
(NULL, 'AP2', 4, 'A3', 'admin', 'UU1', NULL, '产品管理', NULL, 'On', #TIME#, #TIME#),
(NULL, 'AN1', 5, 'A3', 'admin', 'UU1', NULL, '新闻管理', NULL, 'On', #TIME#, #TIME#),
(NULL, 'AM1', 6, 'A3', 'admin', 'UU1', NULL, '菜单管理', NULL, 'On', #TIME#, #TIME#),
(NULL, 'AR1', 7, 'A3', 'admin', 'UU1', NULL, '角色管理', NULL, 'On', #TIME#, #TIME#),
(NULL, 'AJ1', 8, 'A3', 'admin', 'UU1', NULL, '招聘管理', NULL, 'On', #TIME#, #TIME#),
(NULL, 'AD1', 9, 'A3', 'admin', 'UU1', NULL, '下载中心', NULL, 'On', #TIME#, #TIME#),
(NULL, 'AS1', 10, 'A3', 'admin', 'UU1', NULL, '单页面管理', NULL, 'On', #TIME#, #TIME#),
(NULL, 'AC1', 11, 'A3', 'admin', 'UU1', NULL, '留言管理', NULL, 'On', #TIME#, #TIME#),
...
(NULL, 'APPP9', 9, 'AP3', 'admin', 'UU1', NULL, '采供分类', 'psb-cls/index', 'On', #TIME#, #TIME#),
(NULL, 'APPP10', 10, 'AP3', 'admin', 'UU1', NULL, '添加采供分类', 'psb-cls/create', 'On', #TIME#, #TIME#),
(NULL, 'APPP11', 11, 'AP3', 'admin', 'UU1', NULL, '查看提交价格', 'sp-offer/index', 'On', #TIME#, #TIME#),
(NULL, 'APPP12', 12, 'AP3', 'admin', 'UU1', NULL, '导航分类', 'nav-cls/index', 'On', #TIME#, #TIME#),
(NULL, 'APPP13', 13, 'AP3', 'admin', 'UU1', NULL, '添加导航分类', 'nav-cls/create', 'On', #TIME#, #TIME#),
