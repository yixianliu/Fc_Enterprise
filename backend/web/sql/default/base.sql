...
(
    `id`          INT(11)                                             NOT NULL AUTO_INCREMENT,
    `c_key`       VARCHAR(85)                                         NOT NULL COMMENT '配置关键字KEY',
    `name`        VARCHAR(80)                                         NOT NULL COMMENT '名称',
    `parameter`   TEXT                                                NULL COMMENT '值 / 参数',
    `description` TEXT                                                NULL COMMENT '描述',
...
(
    `id`          INT(11)                                         NOT NULL AUTO_INCREMENT,
    `m_key`       VARCHAR(85)                                     NOT NULL COMMENT '菜单关键KEY值',
    `sort_id`     INT(11) UNSIGNED                                NOT NULL COMMENT '排序ID',
    `parent_id`   VARCHAR(85)                                     NULL COMMENT '父类值',
...
(
    ...
    `user_id`     VARCHAR(85)                     NOT NULL COMMENT '发布用户ID',
    `title`       VARCHAR(150)                    NOT NULL COMMENT '标题',
    `content`     TEXT                            NOT NULL COMMENT '内容',
    `keywords`    VARCHAR(120)                    NULL COMMENT '关键字',
    `images`      VARCHAR(2000)                   NULL COMMENT '招聘图片',
...
(
    ...
    `images`      VARCHAR(2000)                   NULL COMMENT '相关图片',
    `thumbnail`   VARCHAR(255)                    NULL COMMENT '相关缩略图',
    `is_language` VARCHAR(25)                     NOT NULL COMMENT '语言类别',
...
(
    ...
    `title`       VARCHAR(150)                    NOT NULL COMMENT '标题',
    `content`     TEXT                            NULL COMMENT '内容',
    `path`        VARCHAR(255)                    NULL COMMENT '上传文件',
    `images`      VARCHAR(2000)                   NULL COMMENT '相关图片',
    `thumbnail`   VARCHAR(255)                    NULL COMMENT '相关缩略图',
    `price`       VARCHAR(85)                     NOT NULL COMMENT '目标价格',
    `num`         INT(11) UNSIGNED                NOT NULL COMMENT '数量',
...
(
    `id`          INT(11)           NOT NULL AUTO_INCREMENT,
    `c_key`       VARCHAR(85)       NOT NULL COMMENT '幻灯片关键KEY,假如为单页面的话,值为Pages',
...
(
    `id`          INT(11)           NOT NULL AUTO_INCREMENT,
    `c_key`       VARCHAR(85)       NOT NULL COMMENT '幻灯片关键KEY',
...
(
    ...
    `m_key`       VARCHAR(85)       NOT NULL COMMENT '对应的菜单KEY',
...
(
    ...
    `keywords`    VARCHAR(155)      NULL COMMENT '关键字',
    `json_data`   VARCHAR(255)      NULL COMMENT 'Json数据',
    `parent_id`   VARCHAR(85)       NULL COMMENT '父类ID',
    `is_using`    SET ('On', 'Off') NOT NULL COMMENT '是否启用',
    `created_at`  integer           NOT NULL DEFAULT '0',
    `updated_at`  integer           NOT NULL DEFAULT '0',
    PRIMARY KEY (`id`),
...
CREATE TABLE `#DB_PREFIX#Module`
(
    `id`          INT(11)           NOT NULL AUTO_INCREMENT,
    `m_key`       VARCHAR(85)       NOT NULL COMMENT '模块KEY',
    `sort_id`     INT(11) UNSIGNED  NOT NULL COMMENT '排序',
    `name`        VARCHAR(85)       NOT NULL COMMENT '名称',
    `description` TEXT              NULL COMMENT '描述',
    `keywords`    VARCHAR(255)      NULL COMMENT '关键字',
    `json_data`   VARCHAR(255)      NULL COMMENT 'Json 数据',
    `is_using`    SET ('On', 'Off') NOT NULL COMMENT '是否启用',
    `created_at`  integer           NOT NULL DEFAULT '0',
    `updated_at`  integer           NOT NULL DEFAULT '0',
    PRIMARY KEY (`id`),
...
(
    ...
    `user_id`     VARCHAR(85)                      NOT NULL COMMENT '用户ID',
    `title`       VARCHAR(150)                     NOT NULL COMMENT '订单标题',
