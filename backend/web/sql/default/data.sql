...
VALUES
(NULL, 'NAME', '网站名称', '#NAME#', NULL, 'On', 'cn', 'web', #TIME#, #TIME#),
(NULL, 'SITE_URL', '网站地址', '#SITE_URL#', NULL, 'On', 'cn', 'web', #TIME#, #TIME#),
(NULL, 'DEVELOPERS', '开发团队', '#DEVELOPERS#', NULL, 'On', 'cn', 'web', #TIME#, #TIME#),
(NULL, 'TITLE', '网站标题', '#TITLE#', NULL, 'On', 'cn', 'web', #TIME#, #TIME#),
(NULL, 'EMAIL', '网站邮箱', '#EMAIL#', NULL, 'On', 'cn', 'web', #TIME#, #TIME#),
(NULL, 'DESCRIPTION', '网站描述', '#DESCRIPTION#', NULL, 'On', 'cn', 'web', #TIME#, #TIME#),
(NULL, 'ICP', '网站ICP', '#ICP#', NULL, 'On', 'cn', 'web', #TIME#, #TIME#),
(NULL, 'PHONE', '联系电话', '#PHONE#', NULL, 'On', 'cn', 'web', #TIME#, #TIME#),
(NULL, 'COPYRIGHT', '网站版权', '#COPYRIGHT#', NULL, 'On', 'cn', 'web', #TIME#, #TIME#),
(NULL, 'KEYWORDS', '网站关键字', '#KEYWORDS#', NULL, 'On', 'cn', 'web', #TIME#, #TIME#),
(NULL, 'ADDRESS', '公司地址', '#ADDRESS#', NULL, 'On', 'cn', 'web', #TIME#, #TIME#),
(NULL, 'PERSON', '公司负责人', '#PERSON#', NULL, 'On', 'cn', 'web', #TIME#, #TIME#),

/* 网站配置 */
(NULL, 'TIME_FORMAT', '时间格式', 'm . d . Y', NULL, 'On', 'cn', 'system', #TIME#, #TIME#),
(NULL, 'THEME_NAME', '主题名称', '默认', NULL, 'On', 'cn', 'system', #TIME#, #TIME#),
(NULL, 'THEME_CUSTOMIZE_PATH', '主题路径', NULL, NULL, 'On', 'cn', 'system', #TIME#, #TIME#),
(NULL, 'FILE_UPLOAD_TYPE', '上传文件格式', 'zip,gz,rar,iso,doc,xsl,ppt,wps', NULL, 'On', 'cn', 'system', #TIME#, #TIME#),
(NULL, 'IMAGE_UPLOAD_TYPE', '上传图片格式', 'jpg,gif,png', NULL, 'On', 'cn', 'system', #TIME#, #TIME#),
(NULL, 'FILE_UPLOAD_SIZE', '上传文件大小', 5000000, NULL, 'On', 'cn', 'system', #TIME#, #TIME#),
(NULL, 'IMAGE_UPLOAD_SIZE', '上传图片大小', 5000000, NULL, 'On', 'cn', 'system', #TIME#, #TIME#),
(NULL, 'JUMP_SUCCEED_NUM', '成功跳转', 5, NULL, 'On', 'cn', 'system', #TIME#, #TIME#),
(NULL, 'JUMP_ERROR_NUM', '错误跳转', 5, NULL, 'On', 'cn', 'system', #TIME#, #TIME#),
(NULL, 'COMMENT_NUM', '留言列表页数量', 50, NULL, 'On', 'cn', 'system', #TIME#, #TIME#),
(NULL, 'POST_VIEW_NUM', '帖子列表页数量', 25, NULL, 'On', 'cn', 'system', #TIME#, #TIME#),
(NULL, 'PRODUCT_VIEW_NUM', '产品列表页数量', 25, NULL, 'On', 'cn', 'system', #TIME#, #TIME#),
(NULL, 'MIC_VIEW_NUM', '产品列表页数量', 25, NULL, 'On', 'cn', 'system', #TIME#, #TIME#),
(NULL, 'TIME_FORMAT', '是否启用时间格式', 'On', NULL, 'On', 'cn', 'system', #TIME#, #TIME#),
(NULL, 'CODE_STATUS', '是否启用验证码', 'On', NULL, 'On', 'cn', 'system', #TIME#, #TIME#),
(NULL, 'REG_STATUS', '是否启用注册', 'On', NULL, 'On', 'cn', 'system', #TIME#, #TIME#),
(NULL, 'WEB_STATUS', '是否启用网站状态', 'On', NULL, 'On', 'cn', 'system', #TIME#, #TIME#),
(NULL, 'LOGIN_STATUS', '是否启用登陆', 'On', NULL, 'On', 'cn', 'system', #TIME#, #TIME#),
(NULL, 'QR_WX_CODE', '公众号二维码', '/themes/default/images/logo.jpg', NULL, 'On', 'cn', 'images', #TIME#, #TIME#),
(NULL, 'QR_MINIPROGRAM_CODE', '小程序二维码', '/themes/default/images/logo.jpg', NULL, 'On', 'cn', 'images', #TIME#, #TIME#),
(NULL, 'WEB_LOGO', '小程序二维码', '/themes/default/images/logo.jpg', NULL, 'On', 'cn', 'images', #TIME#, #TIME#),

/* 英文版 */
(NULL, 'NAME', '网站名称', '#NAME#', NULL, 'On', 'en', 'web', #TIME#, #TIME#),
(NULL, 'SITE_URL', '网站地址', '#SITE_URL#', NULL, 'On', 'en', 'web', #TIME#, #TIME#),
(NULL, 'DEVELOPERS', '开发团队', '#DEVELOPERS#', NULL, 'On', 'en', 'web', #TIME#, #TIME#),
(NULL, 'TITLE', '网站标题', '#TITLE#', NULL, 'On', 'en', 'web', #TIME#, #TIME#),
(NULL, 'EMAIL', '网站邮箱', '#EMAIL#', NULL, 'On', 'en', 'web', #TIME#, #TIME#),
(NULL, 'DESCRIPTION', '网站描述', '#DESCRIPTION#', NULL, 'On', 'en', 'web', #TIME#, #TIME#),
(NULL, 'ICP', '网站ICP', '#ICP#', NULL, 'On', 'cn', 'web', #TIME#, #TIME#),
(NULL, 'PHONE', '联系电话', '#PHONE#', NULL, 'On', 'cn', 'web', #TIME#, #TIME#),
(NULL, 'COPYRIGHT', '网站版权', '#COPYRIGHT#', NULL, 'On', 'en', 'web', #TIME#, #TIME#),
(NULL, 'KEYWORDS', '网站关键字', '#KEYWORDS#', NULL, 'On', 'en', 'web', #TIME#, #TIME#),
(NULL, 'ADDRESS', '公司地址', 'On', NULL, 'On', 'en', 'web', #TIME#, #TIME#),
(NULL, 'PERSON', '公司负责人', 'On', NULL, 'On', 'en', 'web', #TIME#, #TIME#);
...
(NULL, 'EN1', 1, 'E1', 'guest', 'UU1', NULL, '首页', 'center/index', 'index', 'cn', 'On', #TIME#, #TIME#),
(NULL, 'EN2', 2, 'E1', 'guest', 'UC1', NULL, '企业简介', NULL, 'index', 'cn', 'On', #TIME#, #TIME#),
...
(NULL, 'EN5', 5, 'E1', 'guest', 'UC1', NULL, '微信商城', NULL, 'index', 'cn', 'On', #TIME#, #TIME#),
...
(NULL, 'EN8', 8, 'E1', 'guest', 'UC1', NULL, '小程序', NULL, 'index', 'cn', 'On', #TIME#, #TIME#),
...
(NULL, 'APPP9', 9, 'AP3', 'admin', 'UU1', NULL, '采购 / 供应 / 投标 - 分类', 'psb-cls/index', NULL, NULL, 'On', #TIME#, #TIME#),
(NULL, 'APPP10', 10, 'AP3', 'admin', 'UU1', NULL, '添加 - 采购 / 供应 / 投标 - 分类', 'psb-cls/create', NULL, NULL, 'On', #TIME#, #TIME#),
...
(NULL, 'ACenter2', 2, 'AC2', 'admin', 'UU1', NULL, '网站配置', 'conf/index', NULL, NULL, 'On', #TIME#, #TIME#),
