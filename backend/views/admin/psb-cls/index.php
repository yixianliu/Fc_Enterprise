...
function recursionCls($data, $type, $id)
{
    ...
    $html .= $data['name'] . '&nbsp;&nbsp;' .
        Html::a( '编辑', ['update', 'id' => $data['c_key'], 'pid' => $id] ) . '&nbsp; / &nbsp;' .
...
<div class="col-lg-12">
    ...
    <?= Html::a( '供应分类', ['index', 'type' => 'Supply', 'id' => 'S0'], ['class' => "btn btn-primary"] ) ?>
    <?= Html::a( '采购分类', ['index', 'type' => 'Purchase', 'id' => 'P0'], ['class' => "btn btn-primary"] ) ?>
    <?= Html::a( '投标分类', ['index', 'type' => 'Bid', 'id' => 'B0'], ['class' => "btn btn-primary"] ) ?>
