...
class Product extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['title', 'content', 'is_language', 'shop_url', 'is_promote', 'is_hot', 'is_classic', 'is_winnow', 'is_recommend', 'is_using', 'is_comments', 'images', 'thumbnail'], 'string'],
            [['price', 'discount', 'praise', 'forward', 'collection', 'share', 'attention', 'grade', 'user_grade'], 'integer'],
            [['images', 'thumbnail'], 'string', 'max' => 255],
            [['c_key', 's_key', 'product_id', 'is_language'], 'string', 'max' => 85],
