...
<ul class='wraplist'>
    ...
    <li class=""><a href="javascript:;"> <i class="fa fa-folder-open"></i> <span
        ...
        <ul class="sub-menu">
            ...
            <li><a href="javascript:;"> <span class="title">Level 1.2</span> <span class="arrow "></span>
                </a>
                <ul class="sub-menu">
                    ...
                    <li><a href="ujavascript:;"> <span class="title">Level 2.2</span> <span
                        ...
                        <ul class="sub-menu">
                            <li><a href="javascript:;"> <span class="title">Level 3.1</span> <span
                                            class="arrow "></span></a>
                                <ul class="sub-menu">
                                    <li><a href="ujavascript:;"> <span class="title">Level 4.1</span> </a>
                                    </li>
                                    <li><a href="ujavascript:;"> <span class="title">Level 4.2</span> </a>
                                    </li>
                                </ul>
                            </li>
